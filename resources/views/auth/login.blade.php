...
<body class="fondo">
	<div class="container justify-content-center h-100 mt-5">
		<div class="d-flex justify-content-center h-100">
			<div class="user_card">
				<div class="d-flex justify-content-center">
					<div class="brand_logo_container">
						<img src="https://adventech-soluciones.com/wp-content/uploads/2019/05/inventario-icono-png.png" class="brand_logo" alt="Logo">
					</div>
				</div>
				<div class="d-flex justify-content-center form_container">
					<form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row mb-0 d-flex justify-content-center mt-3 login_container">
                            <div class="col-md-8 ">
                                ...
                                @if (Route::has('password.request'))
                                    <a class="btn  text-black btn-link" href="{{ route('password.request') }}">
