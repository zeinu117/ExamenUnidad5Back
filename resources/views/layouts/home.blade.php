...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/estiloss.css')}}">
    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light" style="background-color: #e3f2fd;">
            <div class="container">
                ...
                <a class="navbar-brand" href="{{ url('/areas') }}">
                    <i class="fas fa-list-alt"></i></i> Areas
                </a>
                <a class="navbar-brand" href="{{ url('/responsables') }}">
                    <i class="fas fa-users"></i> Responsables
                </a>
                <a class="navbar-brand" href="{{ url('/inventario') }}">
                    <i class="fas fa-clipboard"></i> Articulos
                </a>
